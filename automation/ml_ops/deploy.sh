...
elif [ "$2" = "Travel-Gen-AI-Pretrained" ]
then
    echo "Local copy sync Travel data"

    aws s3 cp s3://personalize-solution-staging-us-east-1/personalize-immersionday-travel/travel_interactions.csv ./domain/Travel-Gen-AI-Pretrained/data/Interactions/travel_interactions.csv
    aws s3 cp s3://personalize-solution-staging-us-east-1/personalize-immersionday-travel/travel_items.csv ./domain/Travel-Gen-AI-Pretrained/data/Items/travel_items.csv
    aws s3 cp s3://personalize-solution-staging-us-east-1/personalize-immersionday-travel/travel_users.csv ./domain/Travel-Gen-AI-Pretrained/data/Users/travel_users.csv
fi
...
then
    echo "Starting the copy to S3 Travel data"
    aws s3 cp s3://personalize-solution-staging-us-east-1/personalize-immersionday-travel/travel_interactions.csv s3://$bucket/train/interactions.csv
    aws s3 cp s3://personalize-solution-staging-us-east-1/personalize-immersionday-travel/travel_items.csv s3://$bucket/train/items.csv
    aws s3 cp s3://personalize-solution-staging-us-east-1/personalize-immersionday-travel/travel_users.csv s3://$bucket/train/users.csv
    aws s3 cp ./domain/$2/params.json s3://$bucket/train/params.json
fi